// Lines.cpp : Определяет точку входа для приложения.
//
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
    {
        SetWindowPos(hWnd, NULL, WINDOW_START_POS_X, WINDOW_START_POS_Y, WINDOW_WIDTH, WINDOW_HEIGHT, NULL);
    } break;
    case WM_LBUTTONDOWN:
    {
        RollBall(LOWORD(lParam), HIWORD(lParam));
        PrintNumber();
    } break;
    case WM_KEYDOWN:
    {
